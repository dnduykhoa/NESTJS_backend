...
exports.AttributesModule = AttributesModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [
            attribute_groups_controller_1.AttributeGroupsController,
            attribute_definitions_controller_1.AttributeDefinitionsController,
        ],
        providers: [
            attribute_groups_service_1.AttributeGroupsService,
            attribute_definitions_service_1.AttributeDefinitionsService,
        ],
        exports: [
            attribute_groups_service_1.AttributeGroupsService,
            attribute_definitions_service_1.AttributeDefinitionsService,
