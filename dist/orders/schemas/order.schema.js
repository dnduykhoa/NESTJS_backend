...
exports.OrderSchema = exports.Order = exports.PaymentMethod = exports.OrderStatus = void 0;
...
exports.Order = Order;
__decorate([
    (0, mongoose_1.Prop)({ required: true, unique: true, maxlength: 20 }),
...
__decorate([
    (0, mongoose_1.Prop)({ type: [order_item_schema_1.OrderItemSchema], default: [] }),
...
__decorate([
    (0, mongoose_1.Prop)({ default: null }),
    __metadata("design:type", Date)
], Order.prototype, "paymentDeadline", void 0);
...
exports.OrderSchema.index({ paymentDeadline: 1 });
